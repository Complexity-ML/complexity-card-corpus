...
_RESPONSE_ORDERS_BY_TASK = {
    ...
    "conversation_empathy": (
        ...
        "state_reflection>agency>acknowledgment>question",
        "agency>acknowledgment>state_reflection>question",
        "acknowledgment>state_reflection>question>agency",
    ),
    "grounded_qa": (
    ...
    "safety_uncertainty": (
        ...
        "boundary>action>escalation",
        "boundary>escalation>action",
        "escalation>action>boundary",
        "escalation>boundary>action",
    ),
    "practical_action": (

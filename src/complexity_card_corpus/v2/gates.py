...
V2_RELEASE_GATES = (
    ...
    V2Gate("composition.semantic_frame_provenance", "composition", True),
    V2Gate("composition.prompt_answer_plan_independence", "composition", True),
    V2Gate("composition.compatibility_graph_validity", "composition", True),
    V2Gate("composition.compatibility_graph_coverage", "composition", True),
    V2Gate("composition.function_signature_diversity", "composition", True),
    V2Gate("composition.thinking_budget", "composition", True),
    V2Gate("composition.contextual_multi_turn", "composition", True),
    V2Gate("composition.contextual_history_dependency", "composition", True),
    ...
    V2Gate("behavior.capability_support_volume", "behavior", True),
    V2Gate("behavior.capability_support_domains", "behavior", True),
    V2Gate("behavior.capability_surface_diversity", "behavior", True),
    V2Gate("split.exact_leakage", "split", True),
    V2Gate("split.near_duplicate_leakage", "split", True),
    V2Gate("split.composition_leakage", "split", True),
